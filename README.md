...
![AS-IS və TO-BE prosesləri](AsIs_ToBe_Process.png)

## Layihə sənədləri

| Sənəd                              | Orijinal fayl                                           | PDF versiyası                                         |
| ---------------------------------- | ------------------------------------------------------- | ----------------------------------------------------- |
| Mövcud prosesin analizi            | [Word faylı](https://docs.google.com/document/d/1JqVcDvxxCE1gt8EwD7UM05C87j-SCr3xz3J1xLG9m_Y/edit?usp=share_link)          | [PDF-də bax](Current_Process_Analysis.pdf)         |
...
| Stakeholder sualları               | [Word faylı](https://docs.google.com/document/d/1dLZVW4cy71SPCmtWMWcJerUv9o5uaH-aQfFfRMerl7I/edit?usp=share_link)             | [PDF-də bax](Stakeholder_Questions.pdf)            |
